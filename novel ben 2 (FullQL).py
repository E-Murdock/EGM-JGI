# -*- coding: utf-8 -*-
"""
Created on Wed Dec 21 12:31:16 2022
...
#or
results = pd.read_csv("c:/users/mudoe/desktop/hetexp working/fullql/fresh run/results.csv")
...
Na = 22.989218
H = 1.007276
output = pd.read_csv("c:/users/mudoe/desktop/hetexp working/fullql/fresh run/filler.csv")
